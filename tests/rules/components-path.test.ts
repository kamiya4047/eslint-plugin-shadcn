...
describe('components-path', () => {
  ...
  ruleTester.run('should allow imports from local components/ui', rule, {
    valid: [
      {
  ...
  ruleTester.run('should preserve quote style in fixes', rule, {
    valid: [],
    invalid: [
      {
  ...
  ruleTester.run('should prevent direct imports from UI primitive packages', rule, {
    valid: [],
    invalid: [
      {
        code: 'import { Button } from "@radix-ui/react-button";',
