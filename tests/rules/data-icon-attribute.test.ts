...
describe('data-icon-attribute', () => {
  it('should allow icons with data-icon attribute', () => {
    ruleTester.run('data-icon-attribute', rule, {
      valid: [
        {
          code: `
  ...
  it('should enforce data-icon attribute on icons in Button and Badge', () => {
    ruleTester.run('data-icon-attribute', rule, {
      valid: [],
      invalid: [
        {
